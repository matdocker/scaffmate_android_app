 ...
 */
public class EntryAndExitsFragment extends Fragment {
    ...
    public class SavedTabsListAdapter extends BaseExpandableListAdapter {
        ...
        private String[][] children = {
                ...
                //Stairs
                {       "Stairs should be secured to the scaffold bay.",

                        "If stairs cannot be self-secured to the scaffold they should be lashed. If not secured the designer or supplier should provide" +
                                "documentation showing the maximum amount of clearance allowed between the transom  and the top and bottom of the stair module.",

                        "The gap between the end of a stair module and a transom should be as small as possible. Large gaps can lead to stairs dislodging " +
        ...
        public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
            TextView textView = new TextView(EntryAndExitsFragment.this.getActivity());
